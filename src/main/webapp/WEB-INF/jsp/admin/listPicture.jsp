                ...
                <div>
                    <div class="panel panel-warning addPictureDiv">
                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormSingle" action="picture_add" enctype="multipart/form-data">
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <c:forEach items="${ps}" var="pi">
                            <tr>
                                <td>${pi.id}</td>
                                <td>
                                    <a title="点击查看原图" href="img/product/${product.id}/${pi.id}.jpg">
                                        <img height="50px" src="img/product/${product.id}/${pi.id}.jpg">
                                    </a>
                                </td>
                                <td>
                                    <a deleteLink="true" href="picture_delete?id=${pi.id}">
