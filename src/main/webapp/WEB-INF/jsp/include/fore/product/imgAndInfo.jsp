...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        <img src="img/product/${p.id}/${p.pictures[0].id}.jpg" class="bigImg">
        <div class="smallImageDiv">
            <c:forEach items="${p.pictures}" var="pi">
                <img src="img/product/${pi.pid}/${pi.id}.jpg" bigImageURL="img/product/${pi.pid}/${pi.id}.jpg" class="smallImage">
            </c:forEach>
        </div>
