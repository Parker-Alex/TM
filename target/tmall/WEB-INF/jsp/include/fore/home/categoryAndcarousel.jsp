...
<script>
    ...
    //------------------猫耳朵特效---------------------------------
        ...
        // var left = $("div#carousel-of-product").offset();
    ...
    // });
	// $("div.productsAsideCategorys div.categoryMenu").mouseleave(function () {
	// 	$("div.categoryMenu").hide();
	// });
});
</script>
...
<div class="headbar show1">
	<div class="head ">
		...
		<span id="category" style="margin-left:10px">商品分类</span>
